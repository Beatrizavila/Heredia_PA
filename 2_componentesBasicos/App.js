...
import { StyleSheet, Text, View, Image, Switch, Modal, Pressable, Button, Alert, SafeAreaView} from "react-native";
  ...
  return(
    ...
    <View>
      <Image
          style={page.tinyLogo}
          source={{
            uri: 'https://blog.digital-pineapple.com.mx/wp-content/uploads/2021/01/0_oZLL-N4dGNlBe4Oh.png;'
          }}
        />
      <Text style={flattenStyle}>React Native Beatriz</Text>
      <Text>Estilo:</Text>
